import { Sparkles, Shield, Eye, Database, Lock, UserCheck, AlertTriangle, Globe, Mail, Settings } from "lucide-react";
        ...
        <div className="space-y-8">
          ...
          <Alert className="border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-950/50">
            ...
            <AlertDescription className="text-orange-800 dark:text-orange-200">
              <strong>Beta Service Notice:</strong> As a beta service, our data handling practices 
              may evolve. We will notify users of any significant changes to this Privacy Policy 
              and provide appropriate migration options for existing data.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p>
                This policy applies to our website, application, and all related services. By using 
                Vanita, you consent to the practices described in this Privacy Policy.
              </p>
              <p>
                <strong>Key Commitment:</strong> We believe in transparency, data minimization, and 
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                <li>Prompts are processed in real-time and not permanently stored by OpenAI</li>
                <li>We do not share personal identifying information with OpenAI</li>
                <li>API responses are used solely to provide diagram generation services</li>
              </ul>

              <h4>1.4 Beta Testing Data Handling</h4>
              <ul>
                <li>Beta usage data helps us identify bugs and improve functionality</li>
                <li>We may collect additional diagnostic information during beta phases</li>
                <li>Beta feedback and reports are stored securely and used for development</li>
                <li>Data collected during beta may be retained for service improvement</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                ...
                <li><strong>At Rest:</strong> Stored data is encrypted using AES-256 encryption standards</li>
                <li><strong>Database Security:</strong> PostgreSQL databases with encrypted storage and secure connections</li>
                <li><strong>API Communications:</strong> All third-party API calls use encrypted channels</li>
              </ul>
              ...
              <ul>
                ...
                <li><strong>Backups:</strong> Regular encrypted backups with secure off-site storage</li>
                <li><strong>Data Isolation:</strong> User data is logically separated and access-controlled</li>
              </ul>

              <h4>2.3 Authentication Safeguards</h4>
              <ul>
                <li><strong>OAuth Security:</strong> GitHub OAuth 2.0 with secure token handling</li>
                <li><strong>Session Management:</strong> Secure session tokens with appropriate expiration</li>
                <li><strong>CSRF Protection:</strong> Cross-site request forgery protection on all forms</li>
                <li><strong>Rate Limiting:</strong> API rate limiting to prevent abuse and DoS attacks</li>
              </ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                ...
                <li><strong>Review:</strong> View your account information, diagrams, and usage history through your dashboard</li>
                <li><strong>Export:</strong> Download your created diagrams in various formats (PNG, SVG, etc.)</li>
              </ul>

              <h4>3.2 Data Correction and Deletion</h4>
              <ul>
                <li><strong>Correction:</strong> Update incorrect or incomplete personal information</li>
                <li><strong>Deletion:</strong> Request complete deletion of your account and associated data</li>
                <li><strong>Selective Deletion:</strong> Delete specific diagrams or conversation history</li>
                <li><strong>Right to be Forgotten:</strong> Complete removal from our systems (subject to legal requirements)</li>
              </ul>

              <h4>3.3 Privacy Preferences Management</h4>
              <ul>
                <li><strong>Analytics Opt-out:</strong> Disable usage analytics and tracking</li>
                <li><strong>Communication Preferences:</strong> Control email notifications and updates</li>
                <li><strong>Data Processing Consent:</strong> Withdraw consent for non-essential processing</li>
                <li><strong>Third-party Sharing:</strong> Control how your data is shared with service providers</li>
              </ul>

              <h4>3.4 Beta Tester Specific Rights</h4>
              <ul>
                <li><strong>Enhanced Data Access:</strong> Additional access to beta testing data and feedback</li>
                <li><strong>Withdrawal Rights:</strong> Right to withdraw from beta testing at any time</li>
                <li><strong>Data Migration:</strong> Assistance with data migration when beta features become stable</li>
                <li><strong>Special Deletion Rights:</strong> Request deletion of beta-specific data collections</li>
              </ul>
              ...
              <ul>
                <li>Contact us through our <Link href="/support" className="text-primary hover:underline">support page</Link></li>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                <li><strong>Service:</strong> Vercel (hosting), Supabase (database), Redis Cloud (caching)</li>
                <li><strong>Purpose:</strong> Application hosting, data storage, and performance optimization</li>
                <li><strong>Data Shared:</strong> All application data and user content</li>
                <li><strong>Security:</strong> SOC 2 Type II compliant infrastructure</li>
                <li><strong>Location:</strong> EU and US data centers with GDPR compliance</li>
              </ul>

              <h4>4.5 Analytics and Monitoring</h4>
              <ul>
                <li><strong>Purpose:</strong> Application performance monitoring and usage analytics</li>
                <li><strong>Data Collection:</strong> Anonymized usage patterns, error logs, performance metrics</li>
                <li><strong>Retention:</strong> Analytics data retained for 12 months</li>
                <li><strong>Opt-out:</strong> You can disable analytics tracking in your account settings</li>
              </ul>

              <h4>4.6 Beta Testing Platforms</h4>
              <ul>
                <li><strong>Internal Tools:</strong> We use internal feedback collection and bug tracking</li>
                <li><strong>Data Sharing:</strong> Beta feedback shared only with our development team</li>
                <li><strong>External Tools:</strong> No external beta testing platforms currently used</li>
                <li><strong>Security:</strong> Beta data encrypted and access-controlled</li>
              </ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                ...
                <li><strong>Diagrams and Content:</strong> Retained until you delete them or close your account</li>
                <li><strong>Usage Analytics:</strong> Anonymized data retained for 12 months</li>
              ...
              <ul>
                <li>Inactive accounts (no login for 2+ years) are flagged for deletion</li>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                <li><strong>European Union:</strong> Primary data processing location</li>
                <li><strong>United States:</strong> OpenAI API processing, Stripe payments</li>
                <li><strong>Global CDN:</strong> Content delivery for performance optimization</li>
              </ul>
              ...
              <ul>
                ...
                <li>Right to request data localization (where technically feasible)</li>
              </ul>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              <p>
                Vanita is not intended for use by children under 18 years of age. We do not knowingly 
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <ul>
                <li><strong>Minor Changes:</strong> Posted on this page with 7 days notice</li>
                <li><strong>Material Changes:</strong> Email notification 30 days in advance</li>
                <li><strong>Emergency Changes:</strong> Immediate notification for security reasons</li>
              </ul>

              <h4>8.3 Your Options</h4>
              <p>If you disagree with changes to this Privacy Policy, you may:</p>
              <ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-neutral dark:prose-invert max-w-none">
              ...
              <p>
                ...
                your data protection rights have been violated. For EU residents, you can find your 
                local data protection authority at the European Data Protection Board website.
              </p>
